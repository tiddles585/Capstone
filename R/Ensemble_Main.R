  ...
  ##RUNNERS
    ...
    ##Get sMAPES
           ...
           # my_sMAPES_smape<-sMAPE_calculate(json_file,my_ensemble_smape)
            ...
            write_sMAPES(my_sMAPES_mean,'ensemble_SMAPES',paste0('Ensemble_mean',x))
            write_sMAPES(my_sMAPES_median,'ensemble_SMAPES',paste0('Ensemble_median',x))
            message(x)
}
